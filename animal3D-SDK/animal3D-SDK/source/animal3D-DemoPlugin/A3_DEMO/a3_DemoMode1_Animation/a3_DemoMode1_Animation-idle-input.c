...
void a3animation_input_keyCharPress(a3_DemoState const* demoState, a3_DemoMode1_Animation* demoMode, a3i32 const asciiKey, a3i32 const state)
{
	switch (asciiKey)
	{
		...
		a3demoCtrlCaseIncLoop(demoMode->currentToggleIndex, (demoMode->hierarchyPoseGroup_skel->poseCount - 1), '~'); //hierarchy_bvh
	...
	case '+':
		...
		case 9: //triangular, u1, u2, (u0 not modifiable)
			...
			break;
		case 10: //bi-nearest, u, u0, u1
		case 11: //bilinear, u, u0, u1
