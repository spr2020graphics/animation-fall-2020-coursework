...
void a3demo_loadGeometry(a3_DemoState *demoState)
{
	...
	else if (!demoState->streaming || a3fileStreamOpenWrite(fileStream, geometryStream))
	{
		...
		const a3_DemoStateLoadedModel loadedShapes[3] = {
			...
			{ A3_DEMO_OBJ"wolf/Wolf_obj.obj", A3_DEMO_OBJ"xbot/xbot_surface.xml", scale1x_z2y.mm, a3model_calculateVertexTangents },
			{ A3_DEMO_OBJ"wolf/Wolf_obj.obj", A3_DEMO_OBJ"xbot/xbot_joints.xml", scale1x_z2y.mm, a3model_calculateVertexTangents },
		};
